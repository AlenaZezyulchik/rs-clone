...
export const changeThemeBoard = (
  boardItem1: HTMLDivElement,
  boardItem2: HTMLDivElement,
  boardItem3: HTMLDivElement,
  boardItem4: HTMLDivElement
) => {
  const theme = localStorage.getItem('theme') as ThemeType;
  if (boardItem1) {
    if (theme === 'dark') {
...
export const changeThemeNotesContainer = (
  myNotesContainer: HTMLDivElement,
  creatingNoteBlock: HTMLDivElement,
  textNote: HTMLDivElement,
